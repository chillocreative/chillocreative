...
const PortfolioPreview = () => {
    ...
    if (isLoading) {
        return (
            <section className="py-24 bg-[#0a0a16] text-white overflow-hidden relative min-h-[600px] flex items-center justify-center">
        ...
        <section className="py-24 bg-[#0a0a16] text-white overflow-hidden relative">
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                {projects.length > 0 ? (
                            ...
                            <Link key={project.id} href={`/portfolio/${project.slug}`} className="h-full">
                                ...
                                >
                                    ...
                                    <div className="p-8 relative">
                                        ...
                                        <span className="text-xs font-bold text-purple-400 mb-2 block uppercase tracking-wider">
                                            {project.portfolio?.category || 'Project'}
                                        </span>
                                        <h3 className="text-2xl font-bold group-hover:text-purple-300 transition-colors uppercase tracking-tight">{project.title}</h3>
                                    </div>
                                </motion.div>
                            </Link>
                        ))}
                    ...
                    <div className="text-center py-20 bg-gray-900/30 border border-white/5 rounded-2xl backdrop-blur-sm">
                        <p className="text-xl text-gray-500">No featured projects yet. Add some in WordPress!</p>
                    </div>
                )}
