export const countries = [
    ...
    { name: "Czechia (Czech Republic)", code: "+420", flag: "🇨🇿", iso: "CZ" },
    ...
    { name: "Eswatini (fmr. Swaziland)", code: "+268", flag: "🇸🇿", iso: "SZ" },
    ...
    { name: "Holy See", code: "+39", flag: "🇻🇦", iso: "VA" },
    ...
    { name: "Myanmar (formerly Burma)", code: "+95", flag: "🇲🇲", iso: "MM" },
    ...
    { name: "Palestine State", code: "+970", flag: "🇵🇸", iso: "PS" },
